...
from labyrinth.cli.settings import SETTING_DEFINITIONS, SETTING_GROUPS, get_setting, set_setting
from labyrinth.graph.credentials import CredentialBase, NoCredential
...
def add_plugin() -> None:
    ...
    from labyrinth.graph.scanner import _resolve_loader
