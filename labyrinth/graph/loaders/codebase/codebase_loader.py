...
from labyrinth.graph.loaders.codebase.resolvers import LANGUAGE_ANALYZERS
...
class CodebaseLoader(ConceptLoader, abc.ABC):
    ...
    def available_plugins(cls) -> dict[str, type[CodebasePlugin]]:
        from labyrinth.graph.loaders.codebase.plugins import (
            Boto3S3Plugin,
            FastAPIPlugin,
            FlaskPlugin,
            RequestsPlugin,
        ...
        from labyrinth.graph.loaders.codebase.plugins.dockerfile_plugin import DockerfilePlugin
        return {
